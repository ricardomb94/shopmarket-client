...
const App = ()=> {
    ...
    return(
          ...
          <Layout>
            ...
            <Search/>
              <h2 className=" display-4 mb-4 text-center textColor catego p-1">Les nouveautées</h2>
              ...
              <h2 className=" display-4 mb-4 text-center textColor catego p-1">Meilleures ventes</h2>
              <div className="row">
